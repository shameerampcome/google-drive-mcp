...
@mcp.tool()
def about_get(
    fields: Optional[str] = "user,storageQuota,importFormats,exportFormats,maxImportSizes,maxUploadSizes,appInstalled,folderColorPalette,teamDriveThemes,driveThemes"
) -> APIResponse:
